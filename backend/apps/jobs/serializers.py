...
class JobDetailSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        skills = [
            Skill(job_detail=job_detail, **skill_data) for skill_data in job_skills_data
        ]
        responsibilities = [
            Responsibility(job_detail=job_detail, **responsibility_data)
            for responsibility_data in job_responsibilities_data
        ]
        qualifications = [
            Qualification(job_detail=job_detail, **qualification_data)
...
class CategorySerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for job_data in job_category_data:
            ...
            skills.extend(
                [
                    Skill(job_detail=job_detail, **skill_data)
